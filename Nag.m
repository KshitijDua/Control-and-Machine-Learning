...
Niter = 1e6;
beta =0.9; 
V2 = 0; V3 = 0;V4 = 0; Vb2 = 0; Vb3 = 0;Vb4 = 0;
...
for counter = 1:Niter
    ...
    % Gradient step
    V2 = beta*V2 - eta*delta2*x';
    W2 = W2 + beta*V2 - eta*delta2*x';
    V3 = beta*V3 -  eta*delta3*a2';
    W3 = W3 + beta*V3 - eta*delta3*a2';
    V4 = beta*V4 - eta*delta4*a3';
    W4 = W4 + beta*V4 - eta*delta4*a3';
    Vb2 = beta*Vb2 - eta*delta2;
    b2 = b2 + beta*Vb2 - eta*delta2;
    Vb3 = beta*Vb3 - eta*delta3;
    b3 = b3 + beta*Vb3 - eta*delta3;
    Vb4 = beta*Vb4 - eta*delta4;
    b4 = b4 + beta*Vb4 - eta*delta4;
    % Monitor progress
